...
function App() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setChat(prev => [...prev, { text: "AI Error: Rate Limit ya Backend Down!", role: 'ai' }]);
    }
  };
  ...
  // Login nahi hai toh Login screen dikhao
  if (!isAuthenticated) {
    return <Login onLogin={setIsAuthenticated} />;
  }

  // Login hai toh asli Dashboard dikhao
  return (
